...
use nanover_proto::state_update::StateUpdate;
...
/// use nanover_rs::state_broadcaster::StateBroadcaster;
/// use nanover_rs::broadcaster::Broadcaster;
/// use nanover_proto::Mergeable;
/// use nanover_proto::state::StateUpdate;
///
...
///
/// // Send an update.
/// // An update is directly a `StateUpdate` from the nanover protobuf
